...
// 'imgrotateq1a','imgrotateq1b','imgrotateq1c','imgrotateq1d'
var teq2 = null;
var toggleTeq2 = function(r)
{
	var ci = toggleTeq1_i + 1;
	if(ci >= r.length)
	{
		if(teq2 && window.clearTimeout)
			window.clearTimeout(teq2) ;
		return ;
	}
	var cid = '#'+r[ci] ;
	var pos = $(cid).data('pos').split(',') ;
	...
	if(window.setTimeout) {
		teq2 = setTimeout(function() { toggleTeq2(r);}, 500) ;
	}
}
